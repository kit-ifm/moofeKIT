...
function [g_y, y]= g_simpleFunction(g_x, x, g_a, a, g_b, b, g_c, c)
   g_tmp_simpleFunction_00000= 2.* x.^ (2- 1).* g_x;
   tmp_simpleFunction_00000= x.^ 2;
   g_y= g_tmp_simpleFunction_00000* a* b+ tmp_simpleFunction_00000* g_a* b+ tmp_simpleFunction_00000* a* g_b;
   y= tmp_simpleFunction_00000* a* b; 
end
