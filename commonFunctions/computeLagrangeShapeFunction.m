function [N_k_I, dN_xi_k_I, d2N_xi_xi_k_I]  = computeLagrangeShapeFunction(dimension, numberOfNodes, numberOfGausspoints, gaussPoint)
...
% 
if dimension == 1
    [N_k_I, dN_xi_k_I, d2N_xi_xi_k_I] = standardLagrangeShapeFunctions(dimension, numberOfNodes, numberOfGausspoints, gaussPoint);
elseif dimension == 2
    xi = gaussPoint(1,:);
    eta = gaussPoint(2,:);
    if numberOfNodes == 1
    ...
    elseif numberOfNodes == 8
        ...
        % derivative wrt xi
        dN_xi_k_I(1,:,1) = (-(1-eta).*(-xi-eta-1)-(1-xi).*(1-eta))/4;
        ...
        d2N_xi_xi_k_I(1,2,:,1) = -0.5.*xi-0.5.*eta-0.25;
...
elseif dimension == 3
    ...
    if numberOfNodes == 1
        ...
        dN_xi_k_I(1:numberOfGausspoints,1) = 0;
        d2N_xi_xi_k_I = zeros(dimension, dimension, numberOfGausspoints, numberOfNodes);
    elseif numberOfNodes == 4
    ...
    elseif numberOfNodes == 20
        ...
        d2N_xi_xi_k_I(1,1,:,13) = 0.25*(eta.*zeta+eta-zeta-1);
        ...
        d2N_xi_xi_k_I(1,2,:,2) = (1/8)*(-zeta.*zeta-2*eta.*zeta+2*eta-zeta+2);
        d2N_xi_xi_k_I(1,2,:,3) = (1/8)*(zeta.*zeta-2*xi.*zeta-2*eta.*zeta+2*xi+1*eta-zeta);
        d2N_xi_xi_k_I(1,2,:,4) = (1/8)*(-zeta.*zeta+2*eta.*zeta-2*eta-zeta+2);
        ...
        d2N_xi_xi_k_I(1,2,:,13) = 0.25*(xi.*zeta+xi);
        d2N_xi_xi_k_I(1,2,:,14) = -eta.*zeta-eta;
        ...
        d2N_xi_xi_k_I(1,2,:,19) = 0.25*(-zeta.*-zeta+1);
        d2N_xi_xi_k_I(1,2,:,20) = 0.25*(zeta.*zeta-1);
        d2N_xi_xi_k_I(1,3,:,1) = (1/8)*(eta.*eta+2*xi.*eta+2*eta.*zeta-2*xi-eta-2*zeta);
        d2N_xi_xi_k_I(1,3,:,2) = (1/8)*(-eta.*eta-2*eta.*zeta-eta+2*zeta+2);
        d2N_xi_xi_k_I(1,3,:,3) = (1/8)*(-eta.*eta-2*xi.*eta+2*eta.*zeta-2*xi-eta-2*zeta);
        d2N_xi_xi_k_I(1,3,:,4) = (1/8)*(eta.*eta-2*eta.*zeta-eta-2*zeta-2);
        ...
        d2N_xi_xi_k_I(1,3,:,13) = 0.25*(xi.*eta-xi);
        d2N_xi_xi_k_I(1,3,:,14) = 0;
        ...
        d2N_xi_xi_k_I(2,2,:,9) = 0;
        d2N_xi_xi_k_I(2,2,:,10) = 3*xi+3;
	    d2N_xi_xi_k_I(2,1,:,11) = 0;
        ...
        d2N_xi_xi_k_I(2,3,:,1) = (1/8)*(xi.*xi+2*xi.*eta+2*xi.*zeta-2*eta-2*zeta);
        d2N_xi_xi_k_I(2,3,:,2) = (1/8)*(xi.*xi-2*xi.*eta-2*xi.*zeta-2*eta-2*zeta);
        d2N_xi_xi_k_I(2,3,:,3) = (1/8)*(-xi.*xi-2*xi.*eta+2*xi.*zeta-2*eta+2*zeta);
        ...
        d2N_xi_xi_k_I(2,3,:,6) = (1/8)*(-xi.*xi+2*xi.*eta-2*xi.*zeta-xi+2*eta-2*zeta);
  	    d2N_xi_xi_k_I(2,3,:,7) = (1/8)*(xi.*xi+2*xi.*eta+2*xi.*zeta-xi+2*eta+2*zeta);
        d2N_xi_xi_k_I(2,3,:,8) = (1/8)*(xi.*xi-2*xi.*eta-2*xi.*zeta-xi+2*eta+2*zeta);
        d2N_xi_xi_k_I(2,3,:,9) = 0.25*(-xi.*xi+1);
        d2N_xi_xi_k_I(2,3,:,10) = 0;
	    d2N_xi_xi_k_I(2,3,:,11) = 0.25*(-xi.*xi-1);
        ...
        d2N_xi_xi_k_I(2,3,:,16) = 0.5*(xi.*eta-eta);
  	    d2N_xi_xi_k_I(2,3,:,17) = 0.5*(-xi.*eta+eta);
        d2N_xi_xi_k_I(2,3,:,18) = 0.5*(xi.*eta+eta);
        d2N_xi_xi_k_I(2,3,:,19) = 0.5*(-xi.*eta-eta);
        d2N_xi_xi_k_I(2,3,:,20) = 0.5*(xi.*eta-eta);
        % second derivative wrt zeta
	    ...
	    d2N_xi_xi_k_I(3,1,:,11) = d2N_xi_xi_k_I(2,3,:,11);
        ...
        d2N_xi_xi_k_I(3,3,:,8) = 0.25*(eta+1);
        d2N_xi_xi_k_I(3,3,:,9) = 0;
        d2N_xi_xi_k_I(3,3,:,10) = 0;
    ...
    elseif numberOfNodes == 27
        ...
        d2N_xi_xi_k_I(1,1,:,6) = (1/4)*(eta.*eta.*zeta.*zeta-eta.*zeta.*zeta+eta.*eta.*zeta-eta.*zeta);
  	    d2N_xi_xi_k_I(1,1,:,7) = (1/4)*(eta.*eta.*zeta.*zeta-eta.*zeta.*zeta+eta.*eta.*zeta-eta.*zeta);
        ...
        d2N_xi_xi_k_I(1,2,:,3) = (1/8)*(4*xi.*eta.*zeta.*zeta+2*xi.*zeta.*zeta+2.*eta.*zeta.*zeta-4*xi.*eta.*zeta-zeta.*zeta-2*xi.*zeta-2*eta.*zeta-zeta);
        d2N_xi_xi_k_I(1,2,:,4) = (1/8)*(4*xi.*eta.*zeta.*zeta+2*xi.*zeta.*zeta-2.*eta.*zeta.*zeta-4*xi.*eta.*zeta-zeta.*zeta-2*xi.*zeta-2*eta.*zeta+zeta);
        ...
        d2N_xi_xi_k_I(1,2,:,6) = (1/8)*(4*xi.*eta.*zeta.*zeta-2*xi.*zeta.*zeta+2.*eta.*zeta.*zeta+4*xi.*eta.*zeta-zeta.*zeta-2*xi.*zeta+2*eta.*zeta-zeta);
  	    d2N_xi_xi_k_I(1,2,:,7) = (1/8)*(4*xi.*eta.*zeta.*zeta+2*xi.*zeta.*zeta+2.*eta.*zeta.*zeta+4*xi.*eta.*zeta-zeta.*zeta+2*xi.*zeta+2*eta.*zeta+zeta);
        ...
        d2N_xi_xi_k_I(1,2,:,10) = 0.25*(-4*xi.*eta.*zeta.*zeta+2.*xi.*zeta*zeta-2*eta.*zeta.*zeta-zeta.*zeta+4*xi.*eta-2*xi+2*eta-1);
	    d2N_xi_xi_k_I(1,1,:,11) = 0.25*(-4*xi.*eta.*zeta.*zeta-2.*xi.*zeta*zeta-2*eta.*zeta.*zeta-zeta.*zeta+4*xi.*eta+2*xi+2*eta+1);
        ...
        d2N_xi_xi_k_I(1,2,:,21) = 0.5*(-2*xi.*eta.*zeta.*zeta+xi.*zeta.*zeta-2*xi.*eta.*zeta+xi.*zeta);
        ...
        d2N_xi_xi_k_I(1,3,:,3) = (1/8)*(4*xi.*eta.*eta.*zeta+2*xi.*eta.*eta+2.*eta.*eta.*zeta-4*xi.*eta.*eta-eta.*eta-2*xi.*eta-2*eta.*zeta-eta);
        d2N_xi_xi_k_I(1,3,:,4) = (1/8)*(4*xi.*eta.*eta.*zeta+2*xi.*eta.*eta-2.*eta.*eta.*zeta-4*xi.*eta.*eta-eta.*eta-2*xi.*eta-2*eta.*zeta+eta);
        ...
        d2N_xi_xi_k_I(1,3,:,9) = 0.5*(-2.*xi.*eta.*eta.*zeta.*zeta+eta.*eta.*zeta.*zeta+2*xi.*eta*zeta-eta.*zeta);
        d2N_xi_xi_k_I(1,3,:,10) = 0.5*(-2.*xi.*eta.*eta.*zeta.*zeta-eta.*eta.*zeta.*zeta+2*xi.*eta*zeta+eta.*zeta);
	    d2N_xi_xi_k_I(1,3,:,11) = 0.5*(-2.*xi.*eta.*eta.*zeta.*zeta-eta.*eta.*zeta.*zeta-2*xi.*eta*zeta-eta.*zeta);
        d2N_xi_xi_k_I(1,3,:,12) = 0.5*(-2.*xi.*eta.*eta.*zeta.*zeta+eta.*eta.*zeta.*zeta-2*xi.*eta*zeta+eta.*zeta);
	    ...
	    d2N_xi_xi_k_I(1,3,:,15) = 0.5*(-2*xi.*eta.*eta.*eta+xi.*eta.*eta-2*xi*eta.*zeta+xi.*eta);
        d2N_xi_xi_k_I(1,3,:,16) = 0.25*(-4*xi.*eta.*eta.*zeta+2.*xi.*eta.*eta+2*eta.*eta.*zeta-eta.*eta+4*xi.*zeta-2*xi-2*zeta-1);
  	    d2N_xi_xi_k_I(1,3,:,17) = 2.*xi.*eta.*eta.*zeta-xi.*eta.*eta-2*xi.*zeta+xi;
        d2N_xi_xi_k_I(1,3,:,18) = 0.5*(-2*xi.*eta.*eta.*zeta+xi.*eta.*eta+2*xi.*eta.*zeta+xi.*eta);
        ...
        d2N_xi_xi_k_I(1,3,:,21) = 0.5*(-4*xi.*eta.*eta.*zeta-2*xi.*eta.*eta+2*eta.*eta.*zeta+eta.*eta+4*xi.*zeta+2*xi-2*zeta-1);
        ...
        d2N_xi_xi_k_I(2,2,:,10) = 0.5*(-xi.*xi.*zeta.*zeta-xi.*zeta.*zeta+xi.*xi-xi);
	    d2N_xi_xi_k_I(2,1,:,11) = 0.5*(-xi.*xi.*zeta.*zeta-xi.*zeta.*zeta+xi.*xi+xi);
        ...
        d2N_xi_xi_k_I(2,2,:,14) = 0.5*(-xi.*xi.*eta.*zeta-xi.*zeta.*zeta+xi.*xi.*zeta+xi.*zeta);
	    d2N_xi_xi_k_I(2,2,:,15) = 0.5*(-xi.*xi.*zeta.*zeta+xi.*xi.*zeta+zeta.*zeta-zeta);
        d2N_xi_xi_k_I(2,2,:,16) = 0.5*(-xi.*xi.*eta.*zeta+xi.*zeta.*zeta+xi.*xi.*zeta-xi.*zeta);
        ...
        d2N_xi_xi_k_I(2,2,:,19) = 0.5*(-xi.*xi.*zeta.*zeta-xi.*xi.*zeta-xi.*xi.*zeta-xi.*zeta);
        ...
        d2N_xi_xi_k_I(2,2,:,24) = xi.*xi.*zeta.*zeta-xi.*xi-xi;
        ...
        d2N_xi_xi_k_I(2,3,:,6) = (1/8)*(4*xi.*xi.*eta.*zeta+2*xi.*xi*eta-2*xi.*xi.*zeta-4*xi.*eta.*zeta-xi*xi+2*xi.*eta-2*xi.*zeta-xi);
	    ...
	    d2N_xi_xi_k_I(2,3,:,11) = 0.5*(-2*xi.*xi.*eta.*zeta+xi.*xi.*zeta-2*xi.*eta.*zeta+xi.*zeta);
        d2N_xi_xi_k_I(2,3,:,12) = 0.5*(-2*xi.*xi.*eta.*zeta-xi.*xi.*zeta+2*xi.*eta.*zeta+xi.*zeta);
        d2N_xi_xi_k_I(2,3,:,13) = (1/4)*(-4*xi.*xi.*eta.*zeta+2*xi.*xi*eta+2*xi.*xi.*zeta-4*eta.*zeta-2*eta-2*zeta+1);
        d2N_xi_xi_k_I(2,3,:,14) = 0.5*(-2*xi.*xi.*eta.*zeta+xi.*xi.*eta-2*xi.*eta.*zeta+xi.*eta);
	    d2N_xi_xi_k_I(2,3,:,15) = (1/4)*(-4*xi.*xi.*eta.*zeta+2*xi.*xi*eta-2*xi.*xi.*zeta+4*eta.*zeta-2*eta+2*zeta-1);
        ...
        d2N_xi_xi_k_I(2,3,:,18) = (1/4)*(-4*xi.*xi.*eta.*zeta-2*xi.*xi*eta+2*xi.*xi.*zeta+4*eta.*zeta+2*eta-2*zeta-1);
        d2N_xi_xi_k_I(2,3,:,19) = 0.5*(-2*xi.*xi.*eta.*zeta-xi.*xi.*eta-2*xi.*eta.*zeta-xi.*eta);
        d2N_xi_xi_k_I(2,3,:,20) = (1/4)*(-4*xi.*xi.*eta.*zeta-2*xi.*xi*eta-2*xi.*xi.*zeta-xi.*xi+4*eta.*zeta+2*eta-2*zeta+1);
        ...
        d2N_xi_xi_k_I(3,3,:,3) = 0.25*(xi.*xi.*eta.*eta+xi.*eta.*eta-xi.*xi.*eta-xi.*eta);
        ...
        error('shapefunction not implemented');
    end
    %% check shape function
    assert(round(sum(sum(N_k_I,2)),9)==numberOfGausspoints, 'sum of all shapefunctions should be 1');
    %% check first derivative
    xiVector = {'xi', 'eta', 'zeta'};
    for xi_j = 1:dimension
        dN_k_I = reshape(dN_xi_k_I(xi_j,:,:),[size(dN_xi_k_I,2),size(dN_xi_k_I,3)]);
        assert(round(sum(sum(dN_k_I,2)),9)==0, strcat("sum of the derivatives of ", xiVector{xi_j}, " of all shapefunctions should be 0"));
    end
else
...
function [N_k_I, dN_xi_k_I, d2N_xi_xi_k_I] = standardLagrangeShapeFunctions(dimension, numberOfNodes, numberOfGaussPoints, gaussPoint)
dN_xi_k_I = zeros(dimension, numberOfGaussPoints, numberOfNodes);
d2N_xi_xi_k_I = zeros(dimension, dimension, numberOfGaussPoints, numberOfNodes);

nodesXi = elementNodesInLocalCoordinates(1, 'oneDimensional', numberOfNodes);
lAll = ones(numberOfGaussPoints, numberOfNodes);
dlAll = ones(numberOfGaussPoints, numberOfNodes);
d2lAll = ones(numberOfGaussPoints, numberOfNodes);
for k = 1:numberOfGaussPoints
    for j = 1:numberOfNodes
        [l1, dl1, d2l1] = lagrangeBasisPolynomial(j, gaussPoint(1, k), nodesXi, numberOfNodes);
        lAll(k, j) = lAll(k, j) * l1;
        dlAll(k, j) = dlAll(k, j) * dl1;
        d2lAll(k, j) = d2lAll(k, j) * d2l1;
    end
end
...
function [l, dl, d2l] = lagrangeBasisPolynomial(j, xi, nodesXi, numberOfNodes)
l = 1;
for i = 1:numberOfNodes
    if i ~= j
        l = l * (xi - nodesXi(i)) / (nodesXi(j) - nodesXi(i));
    end
end
...
for i = 1:numberOfNodes
    if i ~= j
        ...
        for m = 1:numberOfNodes
            if m ~= i && m ~= j
                factor = factor * (xi - nodesXi(m)) / (nodesXi(j) - nodesXi(m));
            end
        end
        dl = dl + 1 / (nodesXi(j) - nodesXi(i)) * factor;
    end
end
        ...
        for m = 1:numberOfNodes
            if m ~= i && m ~= j
                ...
                for n = 1:numberOfNodes
                    if n ~= i && n ~= j && n ~= m
                        factor2 = factor2 * (xi - nodesXi(n)) / (nodesXi(j) - nodesXi(n));
                    end
                end
                factor1 = factor1 + 1 / (nodesXi(j) - nodesXi(m)) * factor2;
            end
        end
        d2l = d2l + 1 / (nodesXi(j) - nodesXi(i)) * factor1;
    end
end
end