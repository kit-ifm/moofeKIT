...
%% Converts voigt notation to matrix
    ...
    if strcmpi(type, 'stress')
        if size(Av, 1) == 3
            A = [Av(1), Av(3); Av(3), Av(2)];
        elseif size(Av, 1) == 6
            A = [Av(1), Av(4), Av(6); Av(4), Av(2), Av(5); Av(6), Av(5), Av(3)];
        else
            A=Av;
        end
    elseif strcmpi(type, 'strain')
        if size(Av, 1) == 3
            A = [Av(1), 0.5*Av(3); 0.5*Av(3), Av(2)];
        elseif size(Av, 1) == 6
            A = [Av(1), 0.5*Av(4), 0.5*Av(6); 0.5*Av(4), Av(2), 0.5*Av(5); 0.5*Av(6), 0.5*Av(5), Av(3)];
        end
    end
end
