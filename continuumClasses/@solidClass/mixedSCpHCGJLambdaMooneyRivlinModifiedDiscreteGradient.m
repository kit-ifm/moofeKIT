function [rData, kData, elementEnergy, array] = mixedSCpHCGJLambdaMooneyRivlinModifiedDiscreteGradient(obj, setupObject, computePostData, e, rData, kData, dofs, array, stressTensor, flagNumericalTangent)
...
% a = materialObject.a;
% b = materialObject.b;
c = 1e6;%materialObject.c;
d = 1e6;%materialObject.d;
