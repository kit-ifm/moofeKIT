function [rData, kData, elementEnergy, array] = mixedSCInvariantCGcANNEndpoint(obj, setupObject, computePostData, e, rData, kData, dofs, array, stressTensor, flagNumericalTangent)
...
for k = 1:numberOfGausspoints
    ...
    if ~computePostData
        % ENERGY
        WN1 = ANNObject.computeEnergyANN(CxN1,GxN1,cxN1);
        elementEnergy.strainEnergy = elementEnergy.strainEnergy + WN1 * detJ * gaussWeight(k);

        % DERIVATIVES
        [dW_I, dW_II, dW_III] = ANNObject.computeDiffEnergyInvariantANN(IN1,IIN1,IIIN1);
