function [rData, kData, elementEnergy, array] = mixedSCpHGJLambdaMooneyRivlinMidpoint(obj, setupObject, computePostData, e, rData, kData, dofs, array, stressTensor, flagNumericalTangent)
...
for k = 1:numberOfGausspoints
    ...
    if ~computePostData
        ...
        RLambdaJ = RLambdaJ + M_k_I(k, :)' * (dW_JN05-lambdaJN1) * detJ * gaussWeight(k);
        % Strain energy
