function [rData, kData, elementEnergy, array] = displacementSCANNDiscreteGradientBackup(obj, setupObject, computePostData, e, rData, kData, dofs, array, stressTensor, flagNumericalTangent)
