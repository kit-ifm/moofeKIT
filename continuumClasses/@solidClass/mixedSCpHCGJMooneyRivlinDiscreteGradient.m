function [rData, kData, elementEnergy, array] = mixedSCpHCGJMooneyRivlinDiscreteGradient(obj, setupObject, computePostData, e, rData, kData, dofs, array, stressTensor, flagNumericalTangent)
