function [rData, kData, elementEnergy, array] = displacementPetrovGalerkinHooke2DEndpoint(obj, setupObject, computePostData, e, rData, kData, dofs, array, stressTensor, flagNumericalTangent)
