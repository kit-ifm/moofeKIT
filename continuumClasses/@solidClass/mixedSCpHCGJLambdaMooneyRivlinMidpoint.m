function [rData, kData, elementEnergy, array] = mixedSCpHCGJLambdaMooneyRivlinMidpoint(obj, setupObject, computePostData, e, rData, kData, dofs, array, stressTensor, flagNumericalTangent)
