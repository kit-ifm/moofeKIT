function [rData, kData, elementEnergy, array] = deadLoadDiscreteGradient(obj, setupObject, computePostData, e, rData, kData, dofs, array, stressTensor, flagNumericalTangent)
