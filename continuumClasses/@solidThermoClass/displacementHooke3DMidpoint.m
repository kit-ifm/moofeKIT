function [rData, kData, elementEnergy, array] = displacementHooke3DMidpoint(obj, setupObject, computePostData, e, rData, kData, dofs, array, stressTensor, ~)
...
for k = 1:numberOfGausspoints
    ...
    if ~computePostData
        ...
        array = postStressComputation(array, N, k, gaussWeight(k) , detJStruct, stressTensor, setupObject, dimension);
    end    
end
if ~computePostData
    rData{1} = RX;
