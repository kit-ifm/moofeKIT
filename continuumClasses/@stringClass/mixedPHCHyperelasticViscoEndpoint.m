function [rData, kData, elementData, array] = mixedPHCHyperelasticViscoEndpoint(obj, setupObject, computePostData, e, rData, kData, dofs, array, stressTensor, flagNumericalTangent)
