function [rData, kData, elementEnergy, array] = mixedPHViscoPTCHyperelasticMidpoint(obj, setupObject, computePostData, e, rData, kData, dofs, array, stressTensor, flagNumericalTangent)
