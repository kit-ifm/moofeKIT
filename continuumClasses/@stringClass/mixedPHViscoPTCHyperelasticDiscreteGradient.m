function [rData, kData, elementData, array] = mixedPHViscoPTCHyperelasticDiscreteGradient(obj, setupObject, computePostData, e, rData, kData, dofs, array, stressTensor, flagNumericalTangent)
