function [rData, kData, elementData, array] = mixedPHCHyperelasticViscoDiscreteGradient(obj, setupObject, computePostData, e, rData, kData, dofs, array, stressTensor, flagNumericalTangent)
