...
if ~computePostData
    ...
    % pass tangent
    kData{1, 1} = KWW + [stiffness_mat(1,1), stiffness_mat(1,3); stiffness_mat(3,1), stiffness_mat(3,3)];
    kData{1, 2} = KWWprime + [stiffness_mat(1,2), stiffness_mat(1,4); stiffness_mat(3,2), stiffness_mat(3,4)];
    kData{2, 1} = KWprimeW + [stiffness_mat(2,1), stiffness_mat(2,3); stiffness_mat(4,1), stiffness_mat(4,3)];
    kData{2, 2} = KWprimeWprime + [stiffness_mat(2,2), stiffness_mat(2,4); stiffness_mat(4,2), stiffness_mat(4,4)];
end
