...
if ~computePostData
    ...
    kData{1, 2} = KWPhi + [stiffness_mat(1,2), stiffness_mat(1,4); stiffness_mat(3,2), stiffness_mat(3,4)];
    kData{2, 1} = KPhiW + [stiffness_mat(2,1), stiffness_mat(2,3); stiffness_mat(4,1), stiffness_mat(4,3)];
    kData{2, 2} = KPhiPhi + [stiffness_mat(2,2), stiffness_mat(2,4); stiffness_mat(4,2), stiffness_mat(4,4)];
end
