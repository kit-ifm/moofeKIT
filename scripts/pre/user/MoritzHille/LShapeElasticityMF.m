...
solidObject.materialObject.rho = 100;                                                                             % mass density
solidObject.materialObject.a = 1;                                                                                 % material parameter a
solidObject.materialObject.b = 1;                                                                                 % material parameter b
solidObject.materialObject.c = 1;                                                                                 % material parameter c
solidObject.materialObject.d = 2*(solidObject.materialObject.a + 2*solidObject.materialObject.b);     % material parameter d
