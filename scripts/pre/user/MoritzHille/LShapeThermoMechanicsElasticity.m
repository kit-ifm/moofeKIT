...
setupObject.totalTimeSteps = 600;
...
setupObject.plotObject.colorBarLimits = [270 320];
...
area1 = unique(abaqusMeshData.subsets(3).edof);
area2 = unique(abaqusMeshData.subsets(4).edof);
initialThermalField(area1,1) = 313.15*ones(numel(area1),1);
initialThermalField(area2,1) = 273.15*ones(numel(area2),1);
