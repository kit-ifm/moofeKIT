...
GammaXi = GammaXiC*(GammaXiT.*[alpha1, alpha2, alpha3*0, alpha4*0, 0, 0, 0, 1/eta^2, 1, 1]).';
GammaEta = GammaEtaC*(GammaEtaT.*[alpha11, alpha12*0, alpha13, 0, 1/xi^2, alpha16*0, 0, 1, 0, 1]).';
...
% solving
sol = solve(subs([GammaXiBendingLinear; GammaEtaBendingLinear; GammaXiBendingLinear2; GammaEtaBendingLinear2], [x1, x2, x3, x4, y1, y2, y3, y4], [1, 3,4,3/2,1,2,4,4]) == [0; 0; 0; 0], [alpha1, alpha2, alpha11, alpha13]);
sol = solve([GammaXiBendingLinear; GammaEtaBendingLinear; GammaXiBendingLinear2; GammaEtaBendingLinear2] ==[0; 0; 0; 0], [alpha1, alpha2, alpha11, alpha13]);
% sol1 = solve([GammaXiBendingLinear; GammaXiBendingLinear2] ==[0; 0], [alpha1, alpha2]);
save solutionLinearBending sol;
