...
[solidObject.meshObject.nodes, solidObject.meshObject.edof, edofBoundary] = meshCooksMembrane(2, 2, solidObject.shapeFunctionObject.order);
...
%% postprocessing
fprintf('\nDisplacement: %4.3f\n', solidObject.qN1(end, 2)-solidObject.qR(end, 2))