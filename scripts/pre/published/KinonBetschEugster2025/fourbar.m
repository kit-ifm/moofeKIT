...
%setupObject.newton.tolerance = 1e-5; %for classical scheme required.
...
beamObject.numericalTangentObject.type = 'CentralDifferences';
...
%beamObject2.elementNameAdditionalSpecification = 'PhIrreducible';
...
beamObject2.numericalTangentObject.type = 'CentralDifferences';
...
%beamObject3.elementNameAdditionalSpecification = 'PhIrreducible';
...
beamObject3.numericalTangentObject.type = 'CentralDifferences';
...
figure()
plot(time,x)
%matlab2tikz('height', '\figH', 'width', '\figW', 'filename', 'x.tikz', 'showInfo', false, 'floatformat', '%.4g')

figure()
plot(time,y)
%matlab2tikz('height', '\figH', 'width', '\figW', 'filename', 'y.tikz', 'showInfo', false, 'floatformat', '%.4g')

figure()
plot(setupObject.newton.step);
%matlab2tikz('height', '\figH', 'width', '\figW', 'filename', 'iterations.tikz', 'showInfo', false, 'floatformat', '%.4g')
