classdef neoHookeClass < materialPackage.materialSuperClass
    ...
    methods % FIXME mapVoigt -> Klasse -> abstrakt
        [Wpot,P,P_v,FF,errMat] = hyperelasticPF(obj,continuumObject,F,mapVoigt,dimension);
        [Wpot,S,S_v,CC,errMat] = hyperelasticSC(obj,continuumObject,C,mapVoigt,dimension);
        [Wpot,Tau,Tau_v,CC,errMat] = hyperelasticTB(obj,continuumObject,F,mapVoigt,dimension);
