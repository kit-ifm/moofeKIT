...
%[NODES,EDOF,bounEDOFs] = brick3D(lengthX, lengthY, lengthZ, nelx, nely, nelz)
%
%INPUT
%--------------------------------------
...
if order == 1
    ...
    edof2D(:,1)=kron(ones(nelY,1),(1:(nnoX-1))')+kron((0:nnoX:(nnoX)*(nnoY-2))'+0*nnoX,ones(nelX,1));
    edof2D(:,2)=kron(ones(nelY,1),(2:(nnoX-0))')+kron((0:nnoX:(nnoX)*(nnoY-2))'+0*nnoX,ones(nelX,1));
    edof2D(:,3)=kron(ones(nelY,1),(2:(nnoX-0))')+kron((0:nnoX:(nnoX)*(nnoY-2))'+1*nnoX,ones(nelX,1));
    edof2D(:,4)=kron(ones(nelY,1),(1:(nnoX-1))')+kron((0:nnoX:(nnoX)*(nnoY-2))'+1*nnoX,ones(nelX,1));
...
elseif order == 2
    ...
    edof2D = zeros(nelX*nelY,9);
    edof2D(:,1)=kron(ones(nelY,1),(1:2:(nnoX-2))')+kron((0:nnoX*2:(nnoX-1)*(nnoY-1))'+0*nnoX,ones(nelX,1));
    edof2D(:,2)=kron(ones(nelY,1),(3:2:(nnoX-0))')+kron((0:nnoX*2:(nnoX-1)*(nnoY-1))'+0*nnoX,ones(nelX,1));
    edof2D(:,3)=kron(ones(nelY,1),(3:2:(nnoX-0))')+kron((0:nnoX*2:(nnoX-1)*(nnoY-1))'+2*nnoX,ones(nelX,1));
    edof2D(:,4)=kron(ones(nelY,1),(1:2:(nnoX-2))')+kron((0:nnoX*2:(nnoX-1)*(nnoY-1))'+2*nnoX,ones(nelX,1));
    edof2D(:,5)=kron(ones(nelY,1),(2:2:(nnoX-1))')+kron((0:nnoX*2:(nnoX-1)*(nnoY-1))'+0*nnoX,ones(nelX,1));
    edof2D(:,6)=kron(ones(nelY,1),(3:2:(nnoX-0))')+kron((0:nnoX*2:(nnoX-1)*(nnoY-1))'+1*nnoX,ones(nelX,1));
    edof2D(:,7)=kron(ones(nelY,1),(2:2:(nnoX-1))')+kron((0:nnoX*2:(nnoX-1)*(nnoY-1))'+2*nnoX,ones(nelX,1));
    edof2D(:,8)=kron(ones(nelY,1),(1:2:(nnoX-2))')+kron((0:nnoX*2:(nnoX-1)*(nnoY-1))'+1*nnoX,ones(nelX,1));
    edof2D(:,9)=kron(ones(nelY,1),(2:2:(nnoX-1))')+kron((0:nnoX*2:(nnoX-1)*(nnoY-1))'+1*nnoX,ones(nelX,1));
