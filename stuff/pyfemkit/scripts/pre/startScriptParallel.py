...
part1.elementDisplacementType = 'displacementParallel'
# part1.elementDisplacementType = 'displacement'
part1.materialData['rho'] = 1
part1.nodes,part1.edof,bounEDOFs = meshGeneratorCube(1,1,1,20,20,20,1,False)
